...
public class LoginPageTest extends BaseTest {
	...
	@Description("checking the title of the page...tester:Mashiur")
	@Test(priority=1)
	...
	@Description("checking the url of the page...tester:Mashiur")
	@Test(priority=2)
	...
	@Description("checking forgot password link exist...tester:Mashiur")
	@Test(priority=3)
	...
	@Severity(SeverityLevel.CRITICAL)
	@Description("Checking user is able to login with correct username and password...")
	@Test(priority=4)
